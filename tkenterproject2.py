    ...
    for i in range(15):
        if value==correct_answers[i]:
            if value==correct_answers[14]:
                ...
                imglable = Label(root2, bd=0)
                imglable.pack(pady=30)

                Wonlabel = Label(root2, text='CONGRATULATIONS\n YOU BECOME MILLINAIRE', font=("Copperplate Gothic Bold", 25, "bold",), bg='black', bd=0, fg="#8B2323")
                # Wonlabel = Label(root2, text='YOU BECOME MILLIONAIRE', font=("Cambria", 25, "bold"), bg='black', bd=0, fg="white")
                # Wonlabel.pack()
                Wonlabel.pack()
                playimage=ImageTk.PhotoImage(Image.open("playagain_edited1.jpg"))
        ...
        if value not in correct_answers:
            ...
            trybutton=Button(root1,image=tryimage,font=("Copperplate Gothic Bold",19,"bold"),bd=0,fg="white",bg="black",
...
mainimage=ImageTk.PhotoImage(Image.open("bgwindowimg.jpg"))

mainlabel=LabelFrame(root,bd=2,relief=RIDGE,image=mainimage,padx=2)
mainlabel.place(x=0,y=0,width=425,height=490)
...
topframe=Frame(mainlabel,bg="black",padx=100,pady=20,width=40,height=10)
topframe.place(x=100,y=50)

centerframe=Frame(mainlabel,pady=50,width=30,height=50,bg='black')
centerframe.place(x=210,y=200)


bottomframe=Frame(mainlabel,bg="black",bd=0,padx=150,pady=40)
bottomframe.place(x=30,y=520)

rightframe=Frame(mainlabel,padx=30,pady=20,bg="black",width=50,height=15)
...
question_area=Text(bottomframe,font=("Copperplate Gothic Bold",15,"bold"),wrap="word",width=28,height=2,bg="black",fg="#F8F8FF",bd=0)
question_area.place(x=80,y=12)

question_area.insert(END,questions[0])

LabelA=Label(bottomframe,text="A:",bg="black",fg="white",font=("Copperplate Gothic Bold",17,"bold"))
LabelA.place(x=40,y=110)

LabelB=Label(bottomframe,text="B:",bg="black",fg="white",font=("Copperplate Gothic Bold",17,"bold"))
LabelB.place(x=320,y=110)

LabelC=Label(bottomframe,text="C:",bg="black",fg="white",font=("Copperplate Gothic Bold",17,"bold"))
LabelC.place(x=40,y=190)

LabelD=Label(bottomframe,text="D:",bg="black",fg="white",font=("Copperplate Gothic Bold",17,"bold"))
LabelD.place(x=320,y=190)

optionbutton1=Button(bottomframe,text=first_option[0],font=("Copperplate Gothic Bold",17,"bold"),bd=0,fg="white",bg="black",activebackground="black",activeforeground="white",cursor="hand2")
optionbutton1.place(x=70,y=105)

optionbutton2=Button(bottomframe,text=second_option[0],font=("Copperplate Gothic Bold",17,"bold"),bd=0,fg="white",bg="black",activebackground="black",activeforeground="white",cursor="hand2")
optionbutton2.place(x=350,y=105)

optionbutton3=Button(bottomframe,text=third_option[0],font=("Copperplate Gothic Bold",17,"bold"),bd=0,fg="white",bg="black",activebackground="black",activeforeground="white",cursor="hand2")
optionbutton3.place(x=70,y=185)

optionbutton4=Button(bottomframe,text=fourth_option[0],font=("Copperplate Gothic Bold",17,"bold"),bd=0,fg="white",bg="black",activebackground="black",activeforeground="white",cursor="hand2")
...
progressbarlblA=Label(root,text="A",font=("Cambria",17,"bold"),bg="black",fg="white")
progressbarlblB=Label(root,text="B",font=("Cambria",17,"bold"),bg="black",fg="white")
progressbarlblC=Label(root,text="C",font=("Cambria",17,"bold"),bg="black",fg="white")
progressbarlblD=Label(root,text="D",font=("Cambria",17,"bold"),bg="black",fg="white")
